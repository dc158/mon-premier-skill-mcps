...
SUJETS_FRANCE_28 = [
    ...
    "site web mobile-first en 2026","SEO local pour commerces français","Google My Business pour PME",
    ...
    "automatisation marketing pour gagner du temps","IA et outils digitaux pour PME en 2026","email marketing : toujours rentable en 2026",
    ...
    "tendances design à adopter en 2026","présence digitale : checklist complète pour PME","investir dans son image : ROI du design pro",
...
SUJETS_DUBAI_28 = [
    ...
    "charte graphique adaptée au marché du Moyen-Orient","e-commerce au Moyen-Orient : opportunités 2026","Shopify vs solutions locales à Dubai",
    ...
    "tendances webdesign et digital à Dubai 2026","présence digitale : guide complet pour Dubai","ROI du design pro pour entreprises émirati",
...
SUJETS_USA_28 = [
    ...
    "mobile-first web design in 2026","local SEO for US small businesses","Google Business Profile optimization",
    ...
    "AI marketing automation to save time","AI tools for US small businesses in 2026","email marketing: still profitable in 2026",
    "fatal web design mistakes in the US","how to double revenue through digital","success story: US business transformed",
    "design trends to adopt in 2026","digital presence: complete checklist for US SMBs","investing in professional design: ROI breakdown",
...
RSS_CONCURRENTS_NOMMES = {
    ...
    "dubai":["Nexa+digital+agency+Dubai","Blue+Beetle+web+Dubai","Chain+Reaction+digital+Dubai","Digital+Gravity+agency+UAE","agence+digitale+Dubai+francophone+2026"],
...
FAILLES_CONCURRENTS_BASE = [
    ...
    {"faille":"reporting_manuel","description":"Reporting mensuel client préparé manuellement sous Excel/PDF","stat_choc":"8h/mois de reporting manuel par client. Nos concurrents le font encore à la main en 2026.","solution_make":"Google Analytics + Semrush → Make.com → Rapport PDF auto-généré + envoi client automatique","cta_keyword":"REPORTING","marches":["france","dubai","usa"]},
]
